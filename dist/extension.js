...
const node_fetch_1 = __importDefault(__webpack_require__(2));
function activate(context) {
    const disposable = vscode.commands.registerCommand('api-tester.open', () => {
        const panel = vscode.window.createWebviewPanel('apiTester', 'API Tester', vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
        panel.webview.html = getWebviewContent();
        panel.webview.onDidReceiveMessage(async (msg) => {
            if (msg.command === 'sendRequest') {
                try {
                    const res = await (0, node_fetch_1.default)(msg.url, {
                        method: msg.method,
...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16);
...
exports.URL = __webpack_require__(7)["interface"];
...
const Impl = __webpack_require__(10);
...
const punycode = __webpack_require__(12);
const tr46 = __webpack_require__(13);
...
var mappingTable = __webpack_require__(14);
